...
```
Folder.GetSpecialFolder SpecialFolder: Folder.SpecialFolder.ApplicationData SpecialFolderPath=> SpecialFolderPath
Display.SelectFolder Description: $'''Please select your Resource Pack Folder''' InitialDirectory: $'''%SpecialFolderPath%\\.Minecraft''' IsTopMost: True SelectedFolder=> SelectedFolder ButtonPressed=> ButtonPressed
LABEL Download
